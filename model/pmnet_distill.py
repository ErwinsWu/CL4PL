...
class PMNet(nn.Module):
    ...
    def __init__(self, n_blocks, atrous_rates, multi_grids, output_stride):
        ...
        self.encoder = _Encoder(n_blocks, atrous_rates, multi_grids, output_stride)
    ...
    def forward(self, x):
        # Encoder
        x8,x1,x2,x3,x4,x5 = self.encoder(x)

        # Decoder
        xup00 = self.decoder(x8,(x,x1, x2, x3, x4, x5))
